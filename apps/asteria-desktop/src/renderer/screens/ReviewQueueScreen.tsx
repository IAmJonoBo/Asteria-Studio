...
type ReviewQueueLayoutProps = {
  ...
  onBaselineSpacingChange: (value: number | null) => void;
  onBaselineOffsetChange: (value: number | null) => void;
  onBaselineAngleChange: (value: number | null) => void;
  onBaselineSnapChange: (value: boolean) => void;
  onBaselineMarkCorrectChange: (value: boolean) => void;
...
const ReviewQueueLayout = ({
  ...
  baselineSnapToPeaks,
  baselineMarkCorrect,
  onBaselineSpacingChange,
  onBaselineOffsetChange,
  onBaselineAngleChange,
  onBaselineSnapChange,
  onBaselineMarkCorrectChange,
  onApplyScopeChange,
  onSelectIndex,
  onScroll,
  onToggleSelected,
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: "12px" }}>
                  <label style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                    <input
                      ...
                      onChange={(event) => onBaselineSnapChange(event.target.checked)}
                    />
                  ...
                  <label style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                    <input
                      ...
                      onChange={(event) => onBaselineMarkCorrectChange(event.target.checked)}
                    />
...
export function ReviewQueueScreen({
  ...
  return (
    <ReviewQueueLayout
      ...
      onBaselineSpacingChange={setBaselineSpacingPx}
      onBaselineOffsetChange={setBaselineOffsetPx}
      onBaselineAngleChange={setBaselineAngleDeg}
      onBaselineSnapChange={setBaselineSnapToPeaks}
      onBaselineMarkCorrectChange={setBaselineMarkCorrect}
